...
contract E_Voting is ParticialDecriptionVerifier{
    ...
    event VotePublished(bytes32 indexed nullifier, bytes32 indexed hashCipher);
    constructor() {
        admin = msg.sender;
    }
    ...
    function submitVote(bytes32 _nullifier, bytes32 _hashCipher) external onlyActiveElection{
        ...
        emit VotePublished(_nullifier, _hashCipher);
    }
